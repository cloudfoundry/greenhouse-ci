...
Import-Module ./bosh-windows-stemcell-builder/src/github.com/pester/Pester/pester.psm1
foreach ($module in (Get-ChildItem "./bosh-windows-stemcell-builder/bosh-psmodules/modules").Name) {
  Push-Location "./bosh-windows-stemcell-builder/bosh-psmodules/modules/$module"
